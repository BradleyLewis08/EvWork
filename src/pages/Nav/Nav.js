  ...
  return (
    <View style={[styles.container, { marginTop: 5, paddingTop: 10 }]}>
      <View
        style={{
          height: 30,
          borderBottomColor: '#EAEFEC',
          borderBottomWidth: 1,
        }}
      >
        <Text style={{ color: '#8DA697', fontSize: 18 }}>
          Charging Statistics
        </Text>
      </View>
      <View
...
const OtherBars = (bar_props) => {
  return (
    ...
    >
      <Text style={{ fontSize: 12, color: '#8DA697', fontWeight: '400' }}>
        {bar_props.props.title}
      </Text>
      <Text
        style={{
          fontSize: 16,
...
const ChargingHistory = () => {
  return (
    <View style={{ paddingHorizontal: 5 }}>
      ...
      <ChargingHistoryBox date="Aug 9" car="Tesla Model S" cost="$4.75" />
      <ChargingHistoryBox date="Aug 8" car="Hyundai Ioniq 5" cost="$10.01" />
      <ChargingHistoryBox date="Aug 8" car="Tesla Model X" cost="$27.66" />
      <ChargingHistoryBox date="Aug 5" car="Rivian R1T" cost="$12.13" />
      <ChargingHistoryBox date="Aug 5" car="Tesla Model S" cost="$18.04" />
      <ChargingHistoryBox date="Aug 5" car="Hyundai Ioniq 5" cost="$27.46" />
      <ChargingHistoryBox date="Aug 5" car="Tesla Model 3" cost="$5.98" />
      <ChargingHistoryBox date="Aug 3" car="Tesla Model 3" cost="$9.21" />
    </View>
  )
}

const ChargingHistoryBox = ({ date, car, cost }) => {
  return (
    <View
      style={{
        borderBottomColor: '#EAEFEC',
    ...
    >
      <View style={{ display: 'flex', width: '20%' }}>
        <Text style={{ color: '#8DA697', fontSize: 14 }}>{date}</Text>
      </View>
      <View style={{ display: 'flex', width: '65%' }}>
        <Text style={{ color: '#1C4532', fontSize: 14 }}>{car}</Text>
      </View>
      <View style={{ display: 'flex', width: '15%' }}>
        <Text style={{ color: '#48BB78', fontSize: 14, textAlign: 'right' }}>
          {cost}
        </Text>
      </View>
    </View>
  ...
  return (
    <View
      style={{
        flex: 1,
        flexDirection: 'row',
        borderColor: isSwitchOn ? colors.lightGrayPurple : '#EAEFEC',
        backgroundColor: isSwitchOn ? '#48BB78' : '#FFFFFF',
        borderWidth: 2,
        paddingLeft: 10,
        paddingTop: 5,
        paddingBottom: 10,
      ...
      <View style={{ flex: 1, flexDirection: 'column' }}>
        <View style={{ flex: 1, paddingLeft: 10, paddingTop: 8 }}>
          <Text
            style={{
              fontSize: 14,
              color: isSwitchOn ? '#F8FAF9' : '#1C4532',
              fontWeight: '500',
            }}
          >
            My Charger
          ...
          <View style={{ flexDirection: 'row', marginTop: 3 }}>
            <Text
              style={{
                fontSize: 6,
                color: isSwitchOn ? '#FFFFFF' : '#B7C8BE',
                marginTop: 1,
              }}
            >
              {' '}
            ...
            <Text
              style={{
                fontSize: 10,
                color: isSwitchOn ? '#EAEFEC' : '#B7C8BE',
                fontWeight: '400',
              }}
            >
